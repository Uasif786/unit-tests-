...
public class Contact {
    private final String contactId; // unique and non-updatable
    ...
    public void setFirstName(String firstName) {
        if (firstName != null && firstName.length() <= 10) this.firstName = firstName;
    }

    public void setLastName(String lastName) {
        if (lastName != null && lastName.length() <= 10) this.lastName = lastName;
    }

    public void setPhone(String phone) {
        if (phone != null && phone.length() == 10) this.phone = phone;
    }

    public void setAddress(String address) {
        if (address != null && address.length() <= 30) this.address = address;
    }
}
